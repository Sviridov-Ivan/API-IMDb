package com.example.apiimdb.ui.detalis
...
import com.example.apiimdb.databinding.FragmentDetailsBinding
import com.example.apiimdb.ui.DetailsViewPagerAdapter
...
class DetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.viewPager.adapter = DetailsViewPagerAdapter(
            fragmentManager = childFragmentManager, // был supportFragmentManager в Активити, теперь Child
            lifecycle = lifecycle,
            posterUrl = poster,
            movieId = movieId
        )
